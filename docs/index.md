...
fiel ao edital e organizado com notas atômicas, flashcards, revisão espaçada,
simulados, matriz de desempenho e auditoria de fontes.
...
- [Simulados FUCAP](simulados-fucap.md)
- [Auditoria do edital](auditoria-edital.md)
- [Fontes oficiais](../SOURCES.md)

## Plataforma de estudo

O núcleo do projeto é o `Obsidian Vault`, estruturado para operar a preparação
diária:

- notas atômicas para dividir o conteúdo em unidades revisáveis;
- flashcards para active recall;
- revisão espaçada para retenção;
- simulados e questões para medir domínio;
- matriz de desempenho para acompanhar evolução;
- sistema de erros para transformar falhas em revisão.
...
- [Banco de questões no vault](../Obsidian%20Vault/06%20-%20Quest%C3%B5es/_Banco%20de%20Quest%C3%B5es.md)
- [Matriz de desempenho](../Obsidian%20Vault/06%20-%20Quest%C3%B5es/Matriz%20de%20Desempenho.md)

## Flashcards e Anki

- [Flashcards](flashcards.md)
- [Integração com Anki](integracao-anki.md)
- [Decks no vault](../Obsidian%20Vault/04%20-%20Flashcards/)

## Adaptação

O método pode ser adaptado para outros concursos, mas este repositório
permanece específico para Bombeiro Comunitário 2026.

- [Adaptando para outros concursos](adaptando-para-outros-concursos.md)
- [Checklist para novo concurso](checklist-novo-concurso.md)
